...
${OBJECTDIR}/com_stats.o: com_stats.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/com_stats.o com_stats.c
...
${OBJECTDIR}/observable_list.o: observable_list.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/observable_list.o observable_list.c
...
${OBJECTDIR}/tcp_server_control.o: tcp_server_control.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tcp_server_control.o tcp_server_control.c
