...
${OBJECTDIR}/broadcast.o: broadcast.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/broadcast.o broadcast.c
...
${OBJECTDIR}/observed_list.o: observed_list.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/observed_list.o observed_list.c
...
${OBJECTDIR}/tcp_server_info.o: tcp_server_info.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tcp_server_info.o tcp_server_info.c
